...
def register_marshmallow_schemas(spec: APISpec):
    ...
    from app.openapi.schemas import (
        ...
        MetricTemplateOidAuditItemSchema,
        MetricTemplateOidAuditResponseSchema,
    ...
    response_schema_map = {
        ...
        "MetricTemplateOidAuditItem": MetricTemplateOidAuditItemSchema,
        "MetricTemplateOidAuditResponse": MetricTemplateOidAuditResponseSchema,
