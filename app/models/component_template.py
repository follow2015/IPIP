...
class ComponentTemplate(BaseModel):
    ...
    scope = db.Column(
        db.Enum('global', 'customer'), nullable=False, default='global',
    ...
    __table_args__ = (
        ...
        db.Index('ix_component_templates_active_cate', 'is_active', 'category'),
        db.Index('fk_component_templates_customer', 'customer_id'),
        db.Index('idx_ct_scope', 'scope'),
